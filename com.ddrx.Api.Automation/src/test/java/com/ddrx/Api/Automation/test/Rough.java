...
public class Rough {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(ClassLoader.getSystemResource("Environment_properties/api.properties"));
		...
		Restclient rest = Restclient.withDefaultsettings().headers("contenttype", "json");

		// Response re;

		// System.out.println("response"+re.asString());

		System.out.println(Config_Factory.getEnvironmentConfig().adminEmail());

		// loginservice.api("test@bt.maker", "password");
